...
public:
    ...
    ~Triangle() {
        if (_median_a) delete _median_a;
        if (_median_b) delete _median_b;
        if (_median_c) delete _median_c;
    }
    ...
    Triangle& operator=(const Triangle& other) {
        if (this != &other) {
            ...
            _b = other._b;
            _c = other._c;
            _cMiddle = other._cMiddle;
            _aMiddle = other._aMiddle;
            _bMiddle = other._bMiddle;
        }
        return *this;
    }
...
//    os << "A: " << triangle.apexA() << std::endl;
//    os << "B: " << triangle.apexB() << std::endl;
//    os << "C: " << triangle.apexC() << std::endl;
//    return os;
//}
